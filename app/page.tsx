                ...
                {(() => {
                  const body = (
                    <>
                      ...
                      {/* No Coming Soon marker. The card already reads as
                          held back by not being a link, and the label put a
                          second, louder signal beside a title that is doing
                          the quiet version of the same job. */}
