      ...
      <div style={{ background: 'var(--r-paper)', position: 'relative', zIndex: 1 }}>
        <Continue
          ...
          items={[
            ...
            { href: '/studios', label: 'Studios', description: 'Where the thinking is made — clay, fibre, wood, sound, type and software at one bench.', img: '/aura-studios/aura-studios.jpg' },
