...
function Chapter({ title, children, sectionRef, idx, isMobile }: {
  title: string
  ...
  return (
    <div>
      ...
      <div ref={bodyRef} style={{ position: 'relative' }}>
        ...
        <Chapter title="How it Started" sectionRef={setRef(1)} idx={1} isMobile={isMobile}>
        ...
        <Chapter title="What Aura is" sectionRef={setRef(2)} idx={2} isMobile={isMobile}>
        ...
        <Chapter title="What We Forgot" sectionRef={setRef(3)} idx={3} isMobile={isMobile}>
        ...
        <Chapter title="Why Now" sectionRef={setRef(4)} idx={4} isMobile={isMobile}>
        ...
        <Chapter title={'\u1E5Ata \u2014 The Rhythm We Lost'} sectionRef={setRef(5)} idx={5} isMobile={isMobile}>
        ...
        <Chapter title="Natural Intelligence" sectionRef={setRef(6)} idx={6} isMobile={isMobile}>
        ...
        <Chapter title="Three Pillars" sectionRef={setRef(7)} idx={7} isMobile={isMobile}>
        ...
        <Chapter title="What it Feels Like" sectionRef={setRef(8)} idx={8} isMobile={isMobile}>
        ...
        <Chapter title="The Method" sectionRef={setRef(9)} idx={9} isMobile={isMobile}>
        ...
        <Chapter title="The Geography" sectionRef={setRef(10)} idx={10} isMobile={isMobile}>
        ...
        <Chapter title="The Monastic Polymath" sectionRef={setRef(11)} idx={11} isMobile={isMobile}>
        ...
        <Chapter title="The Balance" sectionRef={setRef(12)} idx={12} isMobile={isMobile}>
        ...
        {/* Closing */}
        <div ref={setRef(13)} style={{ marginTop: 'clamp(80px, 12vh, 120px)' }}>
          <Reveal>
            <div className="section-w" style={{ paddingTop: 'clamp(48px, 8vh, 80px)', paddingBottom: 'clamp(80px, 14vh, 140px)', borderTop: '1px solid var(--border)' }}>
              <div style={{ maxWidth: 640 }}>
                <div className="p2" style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
