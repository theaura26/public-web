...
export const DISCIPLINES: Discipline[] = [
  ...
  },
  {
    ...
    practice: [
      'Three things converged to make this possible: foundation models, robotics, and sensors cheap enough to leave outdoors in a monsoon. For the first time a landscape can be made machine-readable, which is what the rest of this depends on.',
      'The knowledge itself is old. Growing in balance was worked out thousands of years ago, in the same traditions this estate still farms by. What never happened was industrialising it, and that is the gap this discipline is built into.',
