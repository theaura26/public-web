...
export const DISCIPLINES: Discipline[] = [
  ...
  },
  {
    ...
    practice: [
      ...
      'The streams are joined rather than filed away separately. A block, a batch, a lot and a date are all addressable, so “what went on this block, and what did the lab say ninety days later” is a query.',
